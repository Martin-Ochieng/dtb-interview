package com.dtb.msaccount.config;
...
public class Configs {
    ...
    public static class ResponseConfig {
        ...
        private String accountExistsResponseMessage;
        private String accountExistsCustomerMessage;

        private String customerNotFoundResponseMessage;
        private String customerNotFoundCustomerMessage;

        private String accountsNotFoundResponseMessage;
        private String accountsNotFoundCustomerMessage;
    }
